...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "bg-gray-700 h-screen w-screen flex items-center justify-center"
      },
      [
        _c(
          "div",
          {
            staticClass:
              "container mx-auto bg-white shadow-xl rounded px-8 pt-6 pb-8 mb-4 flex flex-col w-1/4"
          },
          [
            _c("div", { staticClass: "mb-4" }, [
              _c(
                "label",
                {
                  staticClass: "block text-grey-800 text-sm font-bold mb-2",
                  attrs: { for: "username" }
                },
                [_vm._v("Username")]
              ),
              ...
              _c("input", {
                staticClass:
                  "shadow appearance-none border rounded w-full py-2 px-3 text-grey-800",
            ...
            _c("div", { staticClass: "mb-6" }, [
              ...
              _c("input", {
                staticClass:
                  "shadow appearance-none border rounded w-full py-2 px-3 text-grey-800 mb-3",
                attrs: {
                  id: "password",
                  type: "password",
                  placeholder: "******************"
