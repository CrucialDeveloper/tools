    ...
    <div class="container p-8 mx-auto">
        ...
        <div class="p-4 mt-8 bg-white rounded shadow" v-if="functional">
            <div class="flex items-center">
                <h2 class="text-2xl mr-4">Functional Groups</h2>
        ...
        <div class="p-4 mt-8 bg-white rounded shadow" v-if="content">
            <div class="flex items-center">
                <h2 class="text-2xl mr-4">Content Groups</h2>
                <span>(click to copy)</span>
            </div>
            <div class="mt-4">
...
export default {
    ...
    methods: {
        addTeam() {
            if (
                this.newTeam !== "" &&
                !this.info.teams.includes(this.newTeam)
            ) {
        ...
        removeTag(team) {
            this.info.teams.splice(
                this.info.teams.indexOf(team.toLowerCase()),
                1
            );
        },
        generateNames() {
        ...
        addCopyListener() {
            ...
            elems.forEach(el => {
                el.addEventListener("click", e => {
                    var data = [
                        new ClipboardItem({
                            "text/plain": new Blob([e.target.innerText], {
                                type: "text/plain"
                            })
                        })
                    ];
