<template>
  <div class="flex w-full mt-4">
    <div
      class="flex items-center justify-center flex-shrink-0 w-10 h-10 mr-4 bg-gray-300 rounded"
    ...
    <div class="w-full">
      <div class="flex items-start justify-between w-full text-sm">
        ...
        <button
          class="w-4 h-4 text-gray-200 fill-current hover:text-gray-300"
          @click="editing = true"
        >
      ...
      <div class="mt-2">
        ...
        <div v-if="editing">
          ...
          <div class="flex items-center justify-between mt-2">
            <div>
              <button class="mr-2 text-gray-300 underline" @click="editing = false">Cancel</button>
              <button class="mr-2 text-red-500 underline" @click="deleteComment">Delete</button>
            </div>
            <div>
              <span
                class="mr-2 font-normal text-red-500"
